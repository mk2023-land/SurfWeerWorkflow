...
**Aanvulling op:** `research_reference_methodology.md`, `research_wave_physics_benchmark.md`, `research_benchmark_comparison.md`.
...
| 2. Dagelijks-spot-orakel | de referentie-forecaster, Pat Caldwell, Ben Matson (Swellnet) | combineren modeloutput met 17+ jaar gekalibreerde lokale ervaring | persoonsafhankelijk, moeilijk schaalbaar |
...
Wat Sponsler scheidt van pure modelaars: hij paddle't out om zijn eigen voorspelling te checken. Grant Washburn (filmmaker) zei over hem: *"He is the only forecaster I've seen paddle out to see if his prediction of 50-foot faces is accurate."* Dit komt **identiek** terug bij referentie-forecaster (`research_reference_methodology.md` §1: "bijna dagelijks zelf in het water").
...
Uitgebreid behandeld in `research_reference_methodology.md`. Hier de essentie:
...
- Spectrum-uitleg: zie zijn 2017-post (helaas inmiddels 404), maar `research_reference_methodology.md` §3 documenteert: shoaling-factor ~2× bij T=10s, ~1× bij T=5s; groepssnelheid `1.56 × T` m/s; optimum 6.5–7s voor Noordzee.
...
Dat is precies wat referentie-forecaster zelf zegt (21-8 SMS, geciteerd in `research_reference_methodology.md`): *"kortere interval komt makkelijker over de Vlaamse banken"*. Voor Noordwijk: Z-swells worden bij aankomst NIET zoals een open-zee swell behandeld — de **periode is filterd** en pas wat doorkomt is meestal T=5-7s windswell.
...
Onze observatie (`research_benchmark_comparison.md`): model Tp consistent 1-2s laag versus referentie-forecaster. Pro's kennen die bias en corrigeren mentaal. Sponsler doet dit expliciet via calibration coefficients.
