...
├── ingest_tobias_message.py    # Forecaster-referentieberichten archiveren als training-labels
...
- **Forecaster-referentie-archief**: aparte private repo (user-geleverde SMS + parse-metadata, training-labels). Pad configureerbaar via `TOBIAS_ARCHIVE_DIR` env-var.
