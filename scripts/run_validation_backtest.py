...
Scoort een set gedocumenteerde Tobias-referentiedagen (condities als
...
# Canonieke validatieset — condities uit Tobias' referentie-assessments
...
VALIDATION_SET = [
    {
        "date": "06-08-2025",
        "tobias_noordwijk_assessment": "1,4m groundswell op 10s door windgolven heen (T4)",
        "conditions": {
    ...
    {
        "date": "16-05-2026",
        "tobias_noordwijk_assessment": "0,9m groundswell, windstilte-window 11-12u (T3+T5)",
        "conditions": {
    ...
    {
        "date": "09-09-2025",
        "tobias_noordwijk_assessment": "Nauwelijks wind -> geen golfgeneratie, flat",
        "conditions": {
    ...
    {
        "date": "05-08-2025",
        "tobias_noordwijk_assessment": "1,5m groundswell uit NNW op 10s (T1+T4+T5)",
        "conditions": {
