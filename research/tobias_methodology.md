# Hoe Tobias van surfweer.nl tot zijn surfvoorspellingen komt — Diepteanalyse mei 2026

Onderstaand rapport is een uitbreiding op DEEL 1 van `noordwijk-surf-alert-plan-v3.md`. De analyse van de 13 SMS'jes uit dat document blijft het fundament; deze tekst valideert, corrigeert en verrijkt het met (a) de verse SMS van di 19 mei 2026, (b) materiaal van surfweer.nl zelf, en (c) extern onderzoek naar Tobias' achtergrond en zijn publieke uitleg over spectra, swellsnelheid en getij.

---

## 1. Achtergrond Tobias van Tellingen (validatie van aannames in v3)

- Volledige naam: **Tobias van Tellingen**, opereert onder de bedrijfsnaam **Waves Unlimited** (Triodos-rekening voor SMS-abonnementen).
...
- Bijgenaamd "de Piet Paulusma van het surfen". Actief op Instagram (@surfweer, ~11K volgers) en X (@surfweer).
...
Dit corrigeert een impliciete aanname in v3: Tobias' kracht zit niet in formele meteorologie maar in **17+ jaar gekalibreerde patroonherkenning** op de Noordzee. Voor het algoritme betekent dit: hard te repliceren is zijn calibrated intuition voor "deze setup gaat WEL/NIET surfbaar zijn", niet de fysica.

---

## 2. Validatie van Tobias' data-stack via surfweer.nl/weerlinks

De v3-aannames over zijn stack zijn voor het grootste deel correct, hier de bevestiging plus enkele aanvullingen:

**Forecast-modellen (alle gelinkt vanaf surfweer.nl/weerlinks):**
- **KNMI guidance modelbeoordeling** — `knmi.nl/waarschuwingen_en_verwachtingen/extra/guidance_modelbeoordeling.html`. Dit is geen ruw modelproduct maar de KNMI-meteoroloog die zélf de modellen tegen elkaar afweegt. Tobias gebruikt dus deels **menselijke synthese als input** — iets dat ons algoritme niet 1-op-1 kan repliceren.
...
**Live boeispectra (surfweer.nl/surf/spectra bevestigt v3 exact):**
...
## 3. Tobias' eigen uitleg over het spectrum (publieke artikelen op surfweer.nl)
...
4. **Swell-aankomsttijd berekening** (Tobias zelf): groepssnelheid in diep water ≈ `1,56 × T` m/s, hij zegt: "10 s = 31 kn = 57 km/u; A12 ligt ~570 km, dus 10 uur lead time. Bij 6-8 s bijna verdubbeling." Voor het algoritme: dit is een eenvoudige feature `time_to_coast = afstand_km / (1,56 × T × 3,6)`.
...
### 4.1 Welke databronnen heeft Tobias geraadpleegd?
...
- **"Vloedstroom vol inzetten" vanaf 15u** — astronomisch getij Scheveningen/IJmuiden. Tobias' tij-redenering volgt strikt het schema "vloed = waterstroom naar NO, eb = waterstroom naar ZW". Hoogwater Scheveningen ≈ 18:30-19:00, dus van ~15u vloedfase opgaand naar HW = stroming maximaal richting NO.
...
- Tobias kiest **20-21:30u** als sweetspot voor windafname met restant swell — dat is exact het Type 3 wind-dip patroon uit v3 §1.4 maar zonder echte synoptische trigger: het is gewoon **diurnal wind decay** (zonsondergang ≈ 21:38 op 20 mei).
...
2. **Vlaamse banken** (v3 §1.3): zuid-zwell wordt door Vlaamse banken gedempt naarmate het noordwaarts trekt — maar omdat dit WZW windswell is met korte periode (~6-7s), passeert het juist makkelijk over die banken (Tobias zegt zelf in v3 21-8 SMS: "kortere interval komt makkelijk over de Vlaamse banken").
...
Tobias noemt voor Wijk aan Zee: **10-12:30** EN **15-17** EN **18-20:30**. Dat is uitzonderlijk: drie windows op één dag. Reconstructie:
...
## 6. Noordwijk concreet voor woensdag 20 mei 2026 — alle claims van Tobias
...
- **Tij Noordwijk** (uit Windfinder voor 20 mei 2026): LW 02:13, HW 06:23 (2,09m), LW 14:49 (0,14m), HW 19:01 (1,73m), LW 23:31. Tobias' windows vallen exact rond LW + flank (14-16u) en HW + flank (19:00-21:00).
...
**Matig-tot-OK, geen ALERT-waardige dag.** Tobias noemt het als rideable maar zonder enthousiasme: "kort moment om te surfen", "longboarden", "1m hoogte (niet echt shortboarden)". Vergelijk met zijn high-alert taal in de v3 SMS-set ("forse N-swell", "echte groundswell door windgolven heen") — die ontbreekt volledig hier. In ons score-systeem zou dit een **score 55-65 in twee 1,5-2u windows** moeten zijn, type T5 met zwak T3, en het systeem zou hierop **GEEN alert** moeten sturen, alleen meenemen in digest.

De interessante test voor het algoritme: de dag is voor de meeste dataservices "ok windgolfje, longboard mogelijk" maar Tobias' meerwaarde zit in (a) tij-window-precisie (14-16u i.p.v. heel de middag) en (b) de avond-window-restoratie (19:30-21u) die veel diensten missen. Het algoritme moet deze twee specifieke windows kunnen genereren, niet een blob 14-21u.

---

## 7. Tabel: Noordwijk Woensdag 20 mei 2026 volgens Tobias
...
| Surfability label Tobias | (n.v.t., niet genoemd) | (n.v.t.) | "genoeg hoogte" rideable | te veel wind/stroming impliciet | "longboarden prima" | (afname) |
...
- [surfweer.nl/sms/](https://surfweer.nl/sms/)
- [surfweer.nl/surf/spots/](https://surfweer.nl/surf/spots/)
- [surfweer.nl/surf/spectra/](https://surfweer.nl/surf/spectra/)
- [surfweer.nl/surf/ukmo/](https://surfweer.nl/surf/ukmo/)
- [Surfweer dinsdag 13 juni 2017 — Tobias' spectrum-uitleg](https://surfweer.nl/surf/surfweer-dinsdag-13-juni-2017/)
- [Surfweer eerste weekend van oktober 2023](https://surfweer.nl/surf/surfweer-eerste-weekend-van-oktober-2023/)
- [Een weekje met zomer (wind) swell](https://surfweer.nl/surf/weekje-zomer-wind-swell/)
- [Tobias: de Piet Paulusma van het surfen — Tasha's Surfcamp](https://tashasurfcamp.com/tobias-de-piet-paulusma-van-het-surfen)
- [Instagram @surfweer (Tobias van Tellingen)](https://www.instagram.com/surfweer/?hl=nl)
- [LinkedIn Tobias van Tellingen / Waves Unlimited](https://nl.linkedin.com/in/tellingen)
