...
**Doel:** een referentiekader bouwen om twee Nederlandse golf-voorspellingen tegen te benchmarken — een van surfweer.nl (Tobias) en een van een geautomatiseerd Python-systeem op Open-Meteo wave data. Onderzoek per 19 mei 2026, gebaseerd op Surfline, Stormsurf, NDBC/NOAA, ECMWF/WAM, SWAN/WW3 modeldocumentatie, Coastal Wiki, en Nederlandse/Belgische kustonderzoek.
...
**Concrete checklist: wat moet een geautomatiseerde NL-surf-voorspelling minimaal bevatten om vergelijkbaar te zijn met een pro forecaster zoals Tobias van surfweer.nl?**
...
Voor het Open-Meteo–gedreven Python-systeem is de cruciale vraag bij benchmarking tegen surfweer.nl/Tobias dus niet *"klopt de voorspelde Hs?"* maar *"voorspelt het systeem de juiste combinatie van parameters in het juiste tijdvenster, met expliciete erkenning van zijn beperkingen ten opzichte van een mens met spectrum-inzicht en lokale ervaring?"*
