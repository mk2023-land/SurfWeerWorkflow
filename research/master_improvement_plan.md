...
1. **`gap_analysis.md`** (4411 woorden) — Per-case gap-analyse Tobias' 13 historische SMSes + woensdag 20 mei
...
Plus eerder onderzoek: `wave_physics_benchmark.md`, `tobias_methodology.md`, `benchmark_comparison.md`.
