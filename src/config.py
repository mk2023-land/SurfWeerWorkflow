...
ANTHROPIC_CONFIG = {
    ...
    # in Tobias-stijl prose. ~3× duurder dan Haiku maar absoluut nog steeds
    ...
    'max_tokens': 800,   # Tobias-stijl 4-daagse digest komt makkelijk boven 320
...
# small-but-quality groundswells (Tobias' "smal alert 11-12u zonder wind")
