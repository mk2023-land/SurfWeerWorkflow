...
- `src/llm/prompts/digest_system.md` — de Tobias-stijl SYSTEM_PROMPT (eenmalig
...
class SMSGenerator:
        ...
        for attempt in range(max_attempts):
            ...
            messages.append({
                ...
                "content": (
                    ...
                    f"{issues_str}\n\n"
                    "Genereer het bericht NU OPNIEUW, in dezelfde Tobias-stijl en "
    ...
    def _call_claude(
        ...
        ~3k-token Tobias-prompt kan herbruiken. Eerste call kost ~1.25×
