...
class SMSValidator:
    ...
    def validate_sms(self, sms_text: str, structured_input: dict) -> ValidationResult:
        ...
        # 3b. Verboden eenheden — Tobias gebruikt nooit bft of km/u in onze
        ...
        #
        # Tolerantie-logica:
        #   - Default: 15 min (Tobias is precies, "HW 14:00" mag geen 14:30 zijn).
        ...
        # afwijzing en mag dus altijd. Tobias gebruikt zelf vaak negatieve
