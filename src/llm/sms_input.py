...
def _build_allowed_citations(
    ...
    # referentie-forecaster-stijl: alle HW/LW-tijden van DEZE dag mogen geciteerd worden,
...
def _dedupe_tide_events(events: list[datetime], cluster_minutes: int = 30) -> list[datetime]:
    ...
    eerste tijdstip per cluster — voor referentie-forecaster-stijl SMS is één HW-tijd per
    halve cyclus genoeg.
    """
